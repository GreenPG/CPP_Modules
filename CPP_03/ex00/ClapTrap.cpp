...
ClapTrap & ClapTrap::operator=(const ClapTrap &copy){
	...
	std::cout << "A ClapTrap called " << this->_name << " has been assigned" << std::endl;
	return (*this);
}
...
void ClapTrap::beRepaired(unsigned int amount) {
	...
	this->_hitPoints += amount;
	this->_energyPoints--;
	std::cout << "ClapTrap " << this->_name << " is repaired of " << amount << " hit points. He now has " << this->_hitPoints << " hits points and " << this->_energyPoints << " energy points" << std::endl;
	}
}
